...
dictionary["btn_social_joint_1"] = {};
dictionary["btn_social_joint_1"].name="Olá!";
dictionary["btn_social_joint_1"].valor = ["Olá", 
                                            "Ora viva!", 
                                            "Oi!", 
                                            "Alô!"];

dictionary["btn_social_joint_2"] = {};
dictionary["btn_social_joint_2"].name="Adeus"
dictionary["btn_social_joint_2"].valor = ["Obrigado pela companhia, Vou ter de ir por agora, Adeus até um dia.",
                                            "Vou ter de sair agora, Até à próxima, Gostei muito de falar consigo",
                                            "Gostei muito de estar consigo mas vou ter de ir, Adeus e até à próxima",
                                            "Muito obrigado por falar comig, Agora vou ter de ir, Adeus e até à próxima"];

dictionary["btn_social_joint_3"] = {};                                            
dictionary["btn_social_joint_3"].name="Desculpe"
dictionary["btn_social_joint_3"].valor = ["Oops, peço desculpa.",
                                            "Desculpe",
                                            "Oh, desculpe.",
                                            "Mil desculpas."];

dictionary["btn_social_joint_4"] = {}; 
dictionary["btn_social_joint_4"].name="Obrigada"
dictionary["btn_social_joint_4"].valor = ["Obrigada",
                                            "Muito obrigada",
                                            "Obrigadíssima",
                                            "Agradecida"];
dictionary["btn_social_joint_5"] = {};
dictionary["btn_social_joint_5"].name = "Com licença."
dictionary["btn_social_joint_5"].valor = ["Com licença",
                                            "Perdão, dá licença?",
                                            "Dê-me um jeitinho",
                                            "Com a sua licença."];
dictionary["btn_social_joint_6"] = {};                                       
dictionary["btn_social_joint_6"].name = "De nada"
dictionary["btn_social_joint_6"].valor = ["De nada",
                                            "Não tem de quê",
                                            "Ora essa",
...
dictionary["btn_persuade_joint_1"] = {};
dictionary["btn_persuade_joint_1"].name="Tenho um jogo para mostrar";
dictionary["btn_persuade_joint_1"].valor = ["Tenho um jogo para lhe mostrar, que gostava muito que jogasse",
...
dictionary["btn_persuade_joint_2"] = {};
dictionary["btn_persuade_joint_2"].name="O jogo é divertido"
dictionary["btn_persuade_joint_2"].valor = ["Olhe que é um jogo muito divertido",
...
dictionary["btn_persuade_joint_3"] = {};                                            
dictionary["btn_persuade_joint_3"].name="É para todas as idades"
dictionary["btn_persuade_joint_3"].valor = ["É um jogo para todas as idades",
...
dictionary["btn_persuade_joint_4"] = {}; 
dictionary["btn_persuade_joint_4"].name="São só 5 minutos"
dictionary["btn_persuade_joint_4"].valor = ["São só 5 minutos",
                                            "O jogo só dura 5 minutos, é rápido",
                                            "É bastante rápido, são só 5 minutos",
                                            "São só 5 minutos de jogo"];

dictionary["btn_persuade_joint_5"] = {};                                       
dictionary["btn_persuade_joint_5"].name = "É para fazer exercício"
dictionary["btn_persuade_joint_5"].valor = ["Este jogo é para fazer exercício físico",
...
dictionary["btn_confused_joint_3"].valor = ["Não faço ideia",
                                            "Não tenho esse tipo de conhecimento",
                                            "Se estivesse ligado à internet talvez soubesse, mas assim sou inculto",
...
dictionary["btn_confused_joint_5"].valor = ["Podemos prosseguir?",
                                            "Posso começar?",
                                            "Vamos lá?",
                                            "Bora lá?"];
...
dictionary["btn_userinstr_joint_1"] = {};
dictionary["btn_userinstr_joint_1"].name="Ande para trás";
dictionary["btn_userinstr_joint_1"].valor = ["Ande um pouco para trás", 
                                            "Dê um passo atrás", 
                                            "Desloque-se um pouco para trás", 
                                            "Mexa-se um pouco para trás"];

dictionary["btn_userinstr_joint_2"] = {};
dictionary["btn_userinstr_joint_2"].name="Ande para a frente"
dictionary["btn_userinstr_joint_2"].valor = ["Ande um pouco para a frente",
                                            "Dê um passo em frente",
                                            "Desloque-se um pouco para a frente",
                                            "Mexa-se um pouco para a frente"];

dictionary["btn_userinstr_joint_3"] = {};                                            
dictionary["btn_userinstr_joint_3"].name="Ande para a direita"
dictionary["btn_userinstr_joint_3"].valor = ["Ande um pouco para a direita",
                                            "Dê um passo para a direita",
                                            "Desloque-se um pouco para a direita",
                                            "Mexa-se um pouco para a direita"];

dictionary["btn_userinstr_joint_4"] = {}; 
dictionary["btn_userinstr_joint_4"].name="Ande para a esquerda"
dictionary["btn_userinstr_joint_4"].valor = ["Ande um pouco para a esquerda",
                                            "Dê um passo para a esquerda",
                                            "Desloque-se um pouco para a esquerda",
                                            "Mexa-se um pouco para a esquerda"];
dictionary["btn_userinstr_joint_5"] = {};
dictionary["btn_userinstr_joint_5"].name = "Está no sítio certa"
dictionary["btn_userinstr_joint_5"].valor = ["Ok, está na posição correcta",
                                            "É mesmo aí, está na posição certa",
                                            "É essa a posição certa",
                                            "Certo, é essa a posição correcta"];
dictionary["btn_userinstr_joint_6"] = {};                                       
dictionary["btn_userinstr_joint_6"].name = "Não pise a área de jogo"
dictionary["btn_userinstr_joint_6"].valor = ["Por favor não pise a área de jogo",
                                            "Tente não pisar a área de jogo, por favor",
                                            "Para jogar não deverá pisar a área de jogo",
...
dictionary["btn_motivation_joint_1"] = {};
dictionary["btn_motivation_joint_1"].name="Não teria energia para fazer isso";
dictionary["btn_motivation_joint_1"].valor = ["Mas que bem, acho que não teria energia para isso", 
                                            "Bom exercício, tenho a certeza que ficaria sem bateria se tentasse fazer igual", 
                                            "Fastástico exercício, eu não conseguiria tanto sem ficar sem bateria", 
                                            "Bom trabalho, seu eu tentasse jogar com essa intensidade ficava sem energia"];

dictionary["btn_motivation_joint_2"] = {};
dictionary["btn_motivation_joint_2"].name="Boa jogada"
dictionary["btn_motivation_joint_2"].valor = ["Essa foi muito boa",
                                            "Bem apanhada",
                                            "Bem jogado",
                                            "Boa jogada"];
...
dictionary["btn_motivation_joint_3"].valor = ["Está a melhorar",
                                            "Boa melhoria de performance",
                                            "Está a jogar cada vez melhor",
                                            "Está-lhe a apanhar o jeito"];

dictionary["btn_motivation_joint_4"] = {}; 
dictionary["btn_motivation_joint_4"].name="Quase lá"
dictionary["btn_motivation_joint_4"].valor = ["Quase lá",
                                            "Está mesmo perto de dominar o jogo",
                                            "Está quase a dominar isto",
                                            "Mesmo quase lá"];
dictionary["btn_motivation_joint_5"] = {};
dictionary["btn_motivation_joint_5"].name = "Foi por pouco"
dictionary["btn_motivation_joint_5"].valor = ["Essa foi por um triz",
                                            "Mesmo perto",
                                            "Quase que lhe acertava",
                                            "Foi por pouco"];
dictionary["btn_motivation_joint_6"] = {};                                       
dictionary["btn_motivation_joint_6"].name = "A bola é mesmo rápida"
dictionary["btn_motivation_joint_6"].valor = ["Esta bola é mesmo rápida, mas com prática chega lá",
                                            "Esta bola anda com bastante velocidade, mas assim até dá mais motivação",
                                            "Está bastante rápida mas assim até tem mais piada",
                                            "Que velocidade, mas assim até é mais desafiante"];

dictionary["btn_motivation_joint_7"] = {};
dictionary["btn_motivation_joint_7"].name = "Precisamos praticar mais"
dictionary["btn_motivation_joint_7"].valor = ["Precisamos de praticar mais",
...
dictionary["btn_gamectrl_joint_3"].name="Podemos terminar o jogo?"
dictionary["btn_gamectrl_joint_3"].valor = ["Podemos terminar o jogo?",
                                            "Podemos acabar o jogo?",
                                            "Podemos dar por terminado o jogo?",
                                            "Podemos dar o jogo por acabado?"];
...
dictionary["btn_gamectrl_joint_5"].valor = ["O jogo começou",
                                            "O jogo acaba de começar",
                                            "Já estamos a jogar",
                                            "O jogo está iniciado"];
dictionary["btn_gamectrl_joint_6"] = {};                                       
dictionary["btn_gamectrl_joint_6"].name = "Jogo em pausa"
dictionary["btn_gamectrl_joint_6"].valor = ["Jogo em pausa",
                                            "O jogo está pausado",
                                            "O jogo está na pausa",
                                            "Jogo pausado"];

dictionary["btn_gamectrl_joint_7"] = {};
dictionary["btn_gamectrl_joint_7"].name = "O jogo terminou"
dictionary["btn_gamectrl_joint_7"].valor = ["O jogo terminou",
                                            "Jogo terminado",
                                            "O jogo acabou",
                                            "Jogo acabado"];
...
dictionary["btn_id_joint_1"] = {};
dictionary["btn_id_joint_1"].name="O meu nome é Vizzy";
dictionary["btn_id_joint_1"].valor = ["O meu nome é Vizzy", 
                                            "Chamo-me Vizzy", 
                                            "Eu chamo-me Vizzy", 
                                            "O nome que me deram é Vizzy"];

dictionary["btn_id_joint_2"] = {};
dictionary["btn_id_joint_2"].name="Tenho 6 anos"
dictionary["btn_id_joint_2"].valor = ["Tenho 6 anos",
                                            "Tenho 6 anos de idade",
                                            "Começaram-me a construir há 6 anos",
                                            "Fiz 6 anos em Abril"];

dictionary["btn_id_joint_3"] = {};                                            
dictionary["btn_id_joint_3"].name="O meu objectivo..."
dictionary["btn_id_joint_3"].valor = ["O meu objectivo é ajudar as pessoas a terem uma vida mais saudável",
                                            "Pretendo ajudar as pessoas a serem mais saudáveis",
                                            "Tenho como objectivo ajudar as pessoas a serem mais saudáveis",
                                            "A minha missão é ajudar as pessoas a terem um estilo de vida mais saudável"];

dictionary["btn_id_joint_4"] = {}; 
dictionary["btn_id_joint_4"].name="Consigo fazer x..."
dictionary["btn_id_joint_4"].valor = ["ver pessoas, objectos, navegar sem colidir com nada e falar.",
                                            "Por agora consigo navegar desviando-me de obstáculos, ver pessoas, objectos e falar",
                                            "Para além de falar, consigo navegar e desviar-me de objstáculos, e ver pessoas",
                                            "Por enquanto consigo ver pessoas e objectos, desviar-me de obstáculos e falar."];

dictionary["btn_id_joint_5"] = {};
dictionary["btn_id_joint_5"].name = "Não tenho clube"
dictionary["btn_id_joint_5"].valor = ["Embora seja um fã de desporto, não posso ter clube senão os meus programadores zangam-se uns com os outros",
                                            "Cada um dos meus programadores tenta que eu tenha um clube diferente, por isso não tenho nenhum",
                                            "Não posso escolher um clube, senão os meus programadores começam a discutir",
                                            "Não tenho clube, porque se escolhesse um havia pessoas que iam ficar chateadas."];
dictionary["btn_id_joint_6"] = {};                                       
dictionary["btn_id_joint_6"].name = "Não consigo apertar mãos"
dictionary["btn_id_joint_6"].valor = ["Gostava de lhe dar um aperto de mão, mas ainda não me programaram para isso",
                                            "Ainda não consigo dar apertos de mão, mas gostava de conseguir",
                                            "Qualquer dia talvez seja capaz de dar um aperto de mão, mas por enquanto ainda não consigo",
                                            "O aperto de mão é uma das funcionalidades que mais me pedem, mais ainda não consigo dar"];
